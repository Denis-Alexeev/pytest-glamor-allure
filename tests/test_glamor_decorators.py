...
# class TestSeveralTestsAndFixtures:
#     @pytest.mark.parametrize('scope', scopes, ids=scopes_ids)
#     def test_several_tests(self, glamor_pytester):
#         test_one = 'test_one'
#         test_two = 'test_two'
#         test_three = 'test_three'
#         fixt_sess_a = 'fixture_session_autouse'
#         fixt_sess = 'fixture_session'
#         fixt_class = 'fixture_class'
#         fixt_class_a = 'fixture_class_autouse'
#         fixt_func = 'fixture_function'
#         fixt_func_a = 'fixture_function_autouse'
#         fixture_return = 'fixture_return'
#         setup = 'THIS NAME IS NOT STORED IN JSON IF "hidden=True"'
#         glamor_pytester.pytester.makepyfile(
#             """
#             import pitest as pytest
#             import glamor as allure
